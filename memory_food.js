...
var callSRC = ["AN APPLE", "A BANANA", "A CAKE", "A CARROT", "A CHERRY", "CHOCOLATE", "A COOKIE", "AN ICECREAM", "A LOLLIPOP", "MILK", "AN ORANGE", "PANCAKES",
    "A PIZZA", "A PUMPKIN", "SPAGHETTI", "TEA", "A TOMATO", "A LEMON", "A PLUM", "A PINEAPPLE", "A PEAR", "A MUFFIN", "SANDWICH", "A STRAWBERRY", "BUTTER",
    "CANDY", "CHEESE", "COFFEE", "GRAPES", "JAM", "JUICE", "MUSHROOM"];
var call = [];
var response = [];
var Sounds = { names: [] };
...
$(document).ready(function () {
    $("#version").html("Memory - Food v" + VERSION + " &copy 2014 C00lSch00l");
...
function setUp() {
    ...
    for (var i = 0; i < MAX_ITEMS; i++) {
        ...
        if (call[i] === "AN ORANGE") {
            Sounds.names[i] = new Audio(PATH + "an_orange" + ".mp3");
        } else {
